...
# esquema propio, no Awin) -- vive en /tmp/feeds junto con los demás para
# sobrevivir al reinicio del scan diario, pero el scan no lo descarga
# solo (ver mine_futbolemotion() para por qué esto sigue siendo manual).
FUTBOLEMOTION_SNAPSHOT = os.environ.get(
    "FUTBOLEMOTION_FEED_PATH",
    os.path.join(FEEDS, "futbolemotion_feed.csv"),
)
