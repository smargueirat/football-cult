...
TEAM_PATTERNS = {
    ...
    "bahia": r"esporte clube bahia|\bec bahia\b|\bbahia\b",
    ...
    "nurnberg": r"1\.?\s*fc\s*n[uü]rnberg",
    "schalke04": r"schalke\s*0?4\b|fc schalke",
    ...
    "rbleipzig": r"rb\s?leipzig|red\s?bull leipzig",
    ...
    "nice": r"\bnice\b",
    "rennes": r"\brennes\b|\brennais\b|\bsrfc\b",
    ...
    "lagalaxy": r"\bla galaxy\b|\bl\.a\.?\s+galaxy\b",
    "portlandtimbers": r"\bportland timbers\b",
    "vancouverwhitecaps": r"vancouver whitecaps",
    "orlandocity": r"orlando city",
    "malaga": r"\bm[aá]laga\b",
    "leon": r"club le[oó]n\b",
    "olympiacos": r"olympiacos|olympiakos",
    "guinea": r"\bguinea\b(?! bissau| ecuatorial| bisáu)|\bguin[ée]e\b(?! bissau| équatoriale| equatoriale)|\bguin[ée]\b(?! bissau| equatorial)",
    ...
    "guingamp": r"guingamp",
    "redstarfc": r"red star fc|red star ext[ée]rieur\b",
    ...
    "sandiegofc": r"san diego f\.?c\.?",
    "rbsalzburg": r"rb salzbur(g|go|gh|ourg)|red bull salzburg|rb salzbourg",
    "deportivo": r"deportivo (de )?la coru[ñn]a|deportivo la corogne",
