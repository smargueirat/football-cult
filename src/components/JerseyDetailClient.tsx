        ...
        <div className="flex flex-col gap-6">
          <div>
            ...
            <p className="mt-1 text-sm text-[#8a8a84]">
              {t.detail.storesCompared.replace("{n}", String(inStockCount))}
            </p>
          </div>
            ...
            <p className="mb-3 text-sm font-medium text-[#3a3a36]">
              {selectedSize
                ? t.detail.storesCompared.replace(
                    "{n}",
                    String(sortedOffers.filter((o) => o.inStock && matchesSize(o)).length)
                  )
                : t.detail.allSizes}
            </p>
                      ...
                      <div>
                        ...
                        {!offer.inStock ? (
                          ...
                          <p className="text-xs text-[#8a8a84]">
                            {formatPrice(offer.price, offer.currency, locale)} + {formatPrice(offer.shipping, offer.currency, locale)} {t.detail.shipping.toLowerCase()}
                          </p>
                        )}
                      </div>
                    </div>
