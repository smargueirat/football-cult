...
export const HUB: Record<HubLocale, S> = {
  es: {
    ...
    countryIntro: ({ country, leagues, teams, n, price }) =>
      `${n} camisetas de ${country}: la selección y ${teams} equipos en ${leagues} ligas, comparadas entre varias tiendas. Precio más bajo hoy: ${price}.`,
  ...
  en: {
    ...
    countryIntro: ({ country, leagues, teams, n, price }) =>
      `${n} shirts from ${country}: the national team and ${teams} clubs across ${leagues} leagues, compared across several stores. Lowest price today: ${price}.`,
  ...
  pt: {
    ...
    countryIntro: ({ country, leagues, teams, n, price }) =>
      `${n} camisas — ${country}: a seleção e ${teams} times em ${leagues} ligas, comparadas entre várias lojas. Menor preço hoje: ${price}.`,
  ...
  fr: {
    ...
    countryIntro: ({ country, leagues, teams, n, price }) =>
      `${n} maillots — ${country} : la sélection et ${teams} clubs dans ${leagues} ligues, comparés entre plusieurs boutiques. Prix le plus bas aujourd'hui : ${price}.`,
  ...
  it: {
    ...
    countryIntro: ({ country, leagues, teams, n, price }) =>
      `${n} maglie — ${country}: la nazionale e ${teams} squadre in ${leagues} campionati, confrontate tra vari negozi. Prezzo più basso oggi: ${price}.`,
