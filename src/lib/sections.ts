...
// Foto real curada a mano por sección. Selecciones y Botas usan fotos de
// campaña oficial de adidas (news.adidas.com/thenewsmarket, 2560px,
// fondo real no blanco -- mucho mejor material para un banner ancho a
// pantalla completa que una foto de producto). El resto sigue siendo
// foto real de producto puesta en modelo (fondo blanco de estudio) --
// no encontré una foto de campaña real y comparable para esas
// categorías en el tiempo disponible; son reales y verificadas, solo
// más chicas/con más fondo blanco que las dos de arriba. Cada URL se
// descargó y se miró antes de usarla.
