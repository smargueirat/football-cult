...
export const translations: Record<Locale, Translations> = {
  es: {
    ...
    favoritesPanel: {
      empty: "Todavía no guardaste nada. Tocá el corazón en una tarjeta para guardarla acá.",
      title: "Tus favoritos",
    ...
    favoritesPage: {
      ...
      priceAlertNote: "Te avisamos por mail si alguna camiseta favorita baja de precio.",
    },
    loginPanel: {
      title: "Tu cuenta",
      ...
      favoritesGateText: "Para agregar productos a favoritos y verlos desde cualquier dispositivo, primero tenés que iniciar sesión.",
    },
    categoriesMenu: {
    ...
    compare: {
      ...
      clearAll: "Vaciar",
      maxReached: "Podés comparar hasta 3 productos",
      pageTitle: "Comparar productos",
      empty: "Todavía no agregaste productos para comparar.",
      store: "Tienda",
      price: "Precio",
      shippingCost: "Envío",
      taxes: "Impuestos",
  ...
  pt: {
    ...
    favoritesPanel: {
      empty: "Você ainda não salvou nada. Toque no coração em um card para salvá-lo aqui.",
    ...
    favoritesPage: {
      ...
      browse: "Explorar catálogo",
      priceAlertNote: "Avisamos por e-mail se alguma camisa favorita baixar de preço.",
    },
    loginPanel: {
      title: "Sua conta",
      ...
      favoritesGateText: "Para adicionar produtos aos favoritos e vê-los em qualquer dispositivo, primeiro você precisa fazer login.",
    },
    categoriesMenu: {
      national: "Seleções",
    ...
    compare: {
      ...
      clearAll: "Limpar",
      maxReached: "Você pode comparar até 3 produtos",
      pageTitle: "Comparar produtos",
      empty: "Você ainda não adicionou produtos para comparar.",
      store: "Loja",
      price: "Preço",
      shippingCost: "Frete",
      taxes: "Impostos",
  ...
  en: {
    ...
    favoritesPanel: {
      empty: "You haven't saved anything yet. Tap the heart on a card to save it here.",
    ...
    favoritesPage: {
      ...
      priceAlertNote: "We'll email you if any favorite jersey drops in price.",
    },
    loginPanel: {
      title: "Your account",
      ...
      favoritesGateText: "To add products to favorites and see them on any device, you need to sign in first.",
    },
    categoriesMenu: {
  ...
  fr: {
    ...
    favoritesPanel: {
      empty: "Vous n'avez encore rien enregistré. Touchez le cœur sur une fiche pour l'enregistrer ici.",
      title: "Vos favoris",
      viewAll: "Voir tous les favoris",
    },
    favoritesPage: {
      title: "Vos favoris",
      empty: "Vous n'avez encore rien enregistré.",
      browse: "Explorer le catalogue",
      priceAlertNote: "Nous vous préviendrons par mail si un maillot favori baisse de prix.",
    },
    loginPanel: {
      title: "Votre compte",
      ...
      favoritesGateText: "Pour ajouter des produits aux favoris et les voir sur n'importe quel appareil, vous devez d'abord vous connecter.",
    },
    categoriesMenu: {
    ...
    compare: {
      ...
      pageTitle: "Comparer les produits",
      empty: "Vous n'avez encore ajouté aucun produit à comparer.",
      store: "Boutique",
      price: "Prix",
  ...
  it: {
    ...
    favoritesPanel: {
      empty: "Non hai ancora salvato nulla. Tocca il cuore su una scheda per salvarla qui.",
    ...
    favoritesPage: {
      ...
      browse: "Esplora il catalogo",
      priceAlertNote: "Ti avviseremo via email se una maglia preferita scende di prezzo.",
    },
    loginPanel: {
      ...
      favoritesGateText: "Per aggiungere prodotti ai preferiti e vederli su qualsiasi dispositivo, devi prima accedere.",
    },
    categoriesMenu: {
      national: "Nazionali",
    ...
    compare: {
      ...
      clearAll: "Cancella",
      maxReached: "Puoi confrontare fino a 3 prodotti",
      pageTitle: "Confronta prodotti",
      empty: "Non hai ancora aggiunto nessun prodotto da confrontare.",
      store: "Negozio",
      price: "Prezzo",
